...
|------|------|------|
| 不可替代 | 没有它，对应工作流断裂 | 3 |
| 有替代方案 | 有其他技能或通用能力可覆盖，但本技能更优 | 2 |
| 可有可无 | 通用能力即可完成，技能只是锦上添花 | 1 |

### 指标 3：当前相关性

| 等级 | 定义 | 分值 |
|------|------|------|
| 匹配 | 与当前核心业务/工作方向直接相关 | 3 |
| 部分匹配 | 与当前方向间接相关，偶尔有用 | 2 |
| 不相关 | 业务方向已变化，或属于已结束的项目 | 1 |
...
| 等级 | 定义 | 分值 |
|------|------|------|
| 独有 | 提供其他技能和通用能力都没有的功能 | 3 |
| 部分独有 | 与其他技能有重叠，但有差异化能力 | 2 |
| 完全重叠 | 与其他技能功能高度重复 | 1 |
